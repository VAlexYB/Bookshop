...
class UserInfoService {
    ...
    async changeProfile(data) {
        try {
            const user = await PersonalInfo.findOne( {user : data.userId});
            ...
            user.cardIdFirstDigits = data.cardIdFirstDigits;
            user.cardIdLastDigits = data.cardIdLastDigits;
            if (data.cardIdFirstDigits && data.cardIdLastDigits) {
                user.hasLinkedCard = true;
            }
            await user.save();
            return true;
